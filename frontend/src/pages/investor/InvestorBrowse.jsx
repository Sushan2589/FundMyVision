...
const SAMPLE_IDEAS = [
  {
    id: 'sample-1',
    title: 'Eco-Friendly Smart Packaging (Sample Opportunity)',
    summary: 'Biodegradable smart packaging solutions for e-commerce brands.',
    description: 'A revolutionary packaging system that is 100% biodegradable and features IoT temperature tracking. Complete identity verification to unlock details.',
    category: 'Environment',
    stage: 'Concept',
    funding_needed: 75000,
    owner_name: 'GreenCorp Team'
  },
  {
    id: 'sample-2',
    title: 'AI-Powered Crop Yield Optimizer (Sample Opportunity)',
    summary: 'Predictive precision agriculture software for small-scale farms.',
    description: 'Using satellite imaging and machine learning to optimize irrigation and fertilizer usage. Complete identity verification to unlock details.',
    category: 'Technology',
    stage: 'Prototype',
    funding_needed: 120000,
    owner_name: 'AgriTech Labs'
  }
];
...
export default function InvestorBrowse() {
  ...
  return (
    <DashboardLayout role="investor">
      ...
      {user?.verified !== 2 && (
        <div style={{ padding: 'var(--space-3) var(--space-4)', background: 'var(--color-warning-bg)', border: '1px solid var(--color-warning)', borderRadius: 'var(--radius-md)', marginBottom: 'var(--space-6)', fontSize: 'var(--text-sm)', color: 'var(--color-warning)' }}>
          ⚠️ <strong>Pre-Verification Demo:</strong> You are currently viewing sample opportunities. Please <Link to="/investor/kyc" style={{ textDecoration: 'underline', fontWeight: 'bold', color: 'var(--color-warning)' }}>complete identity verification (KYC)</Link> to unlock all live campaigns, detailed specifications, and contact channels.
        </div>
      )}
