        ...
        <div className="navbar-links">
          ...
          {user && user.role === 'ideator' && (
            <>
              ...
              <Link to="/ideator/interests" className={`navbar-link ${location.pathname === '/ideator/interests' ? 'active' : ''}`}>Interests Received</Link>
              <Link to="/chat" className={`navbar-link ${location.pathname === '/chat' ? 'active' : ''}`}>Chat</Link>
          ...
          {user && user.role === 'investor' && (
            <>
              ...
              <Link to="/chat" className={`navbar-link ${location.pathname === '/chat' ? 'active' : ''}`}>Chat</Link>
              <Link to="/investor/profile" className={`navbar-link ${location.pathname === '/investor/profile' ? 'active' : ''}`}>Profile</Link>
              <Link to="/investor/kyc" className={`navbar-link ${location.pathname === '/investor/kyc' ? 'active' : ''}`}>KYC Status</Link>
            </>
          )}
          {user && user.role === 'admin' && (
            <>
              <Link to="/admin/dashboard" className={`navbar-link ${location.pathname === '/admin/dashboard' ? 'active' : ''}`}>Dashboard</Link>
              <Link to="/admin/kyc" className={`navbar-link ${location.pathname === '/admin/kyc' ? 'active' : ''}`}>KYC Management</Link>
              <Link to="/admin/users" className={`navbar-link ${location.pathname === '/admin/users' ? 'active' : ''}`}>User Directory</Link>
            </>
          )}
        </div>
